...
func (d *Device) GetDeviceFriendlyName() (string, error) {
	...
	var err = d.ps.GetValue(&wca.PKEY_Device_FriendlyName, &pv)
...
func (d *Device) GetMasterVolume() (float32, error) {
	var v float32
	var err = d.aev.GetMasterVolumeLevel(&v)
...
func (d *Device) GetMasterVolumeLevelScalar() (float32, error) {
	var v float32
	var err = d.aev.GetMasterVolumeLevelScalar(&v)
...
func (d *Device) GetChannelCount() (uint32, error) {
	var v uint32
	var err = d.aev.GetChannelCount(&v)
...
func (d *Device) GetMute() (bool, error) {
	var v bool
	var err = d.aev.GetMute(&v)

	return v, err
}

func (d *Device) GetVolumeRange() (float32, float32, float32, error) {
	var minDB, maxDB, incrementDB float32
	var err = d.aev.GetVolumeRange(&minDB, &maxDB, &incrementDB)
